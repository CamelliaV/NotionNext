...
module.exports = {
  ...
  MUSIC_PLAYER_METING_API:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_API || '/api/meting', // 同源代理路由，服务端直连音乐平台，见 pages/api/meting.js
  MUSIC_PLAYER_METING_SERVER:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || 'netease', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '12927716304', // 对应歌单的 id
