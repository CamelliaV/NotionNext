 ...
 * ============================================
 *
 * 侧栏头像和作者名固定返回首页；关于页可通过 Notion 自定义菜单配置为 /about。
 *
 * 以下默认菜单页面如需启用，需要在 Notion 中配置菜单(Menu)：
...
const CONFIG = {
  ...
  // 加载动画显示的站点名称 (右侧竖排大字)
  ENDSPACE_LOADING_SITE_NAME: 'CamelliaV の BLOG', // 站点名称，显示在加载动画右侧
  ...
  ENDSPACE_BANNER_WATERMARK_TEXT: 'CamelliaV の BLOG',
  // 文章详情页右上角水印文字
  ENDSPACE_ARTICLE_WATERMARK_TEXT: 'CamelliaV の BLOG',
