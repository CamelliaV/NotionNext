    ...
    <>
      ...
      <button
        onClick={() => setIsOpen(true)}
         className="fixed right-4 bottom-24 z-40 md:hidden 
                   ...
                   bg-[var(--endspace-bg-primary)] text-[var(--endspace-text-muted)] border-[var(--endspace-border-base)]
      ...
      >
        ...
        <div className="relative w-full h-full flex items-center justify-center">
            <span className="text-[10px] font-bold font-mono group-hover:hidden text-[var(--endspace-text-muted)]">{Math.round(progress)}%</span>
      ...
      <div 
        className={`fixed left-0 right-0 bottom-0 z-50 md:hidden bg-[var(--endspace-bg-primary)] text-[var(--endspace-text-primary)] border-t border-[var(--endspace-border-base)] transition-transform duration-300 ease-out ${
          isOpen ? 'translate-y-0' : 'translate-y-full'
        }`}
        style={{ maxHeight: '70vh' }}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--endspace-border-base)] bg-[var(--endspace-bg-base)]">
        ...
        {/* Progress Bar */}
        <div className="h-1 bg-[var(--endspace-bg-tertiary)]">
          <div 
              ...
              return (
                <button
                  ...
                  className={`w-full text-left py-3 px-4 text-sm transition-all duration-200 border-l-2 ${
                    isActive 
                      ? 'border-[var(--endspace-accent-yellow)] text-[var(--endspace-text-primary)] font-bold bg-[var(--endspace-accent-yellow-dim)]'
